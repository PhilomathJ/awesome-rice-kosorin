...
---@alias Denu.items_source (fun(menu: Denu, args: Denu.show.args, context: Denu.context): XDenuItem.args[])|XDenuItem.args[]

---@alias XDenuItem.args (fun(menu: Denu, args: Denu.show.args, context: Denu.context): XDenuItem)|XDenuItem

---@alias XDenuItem.submenu (fun(parent: Denu): Denu.new.args)|Denu.new.args
...
---@field submenu? XDenuItem.submenu
---@field callback? fun(item: XDenuItem, menu: Denu, context: Denu.context): boolean?
---@field on_show? fun(item: XDenuItem, menu: Denu, args: Denu.show.args, context: Denu.context): boolean?
---@field on_hide? fun(item: XDenuItem, menu: Denu)
---@field on_ready? fun(item_widget?: wibox.widget.base, item: XDenuItem, menu: Denu, args: Denu.show.args, context: Denu.context)
---@field layout_id? string
---@field layout_add? fun(layout: wibox.layout, item_widget: wibox.widget.base)
---@field buttons_builder? fun(item: XDenuItem, menu: Denu, default_click_action: function): awful.button[]
...
---@class Denu : wibox, stylable
---@field package _private Denu.private
---Style properties:
...
---@class Denu.private
---@field parent? Denu
---@field active_submenu? { index: integer, menu: Denu }
---@field submenu_cache? (Denu|false)[]
---@field items? XDenuItem[]
...
---@field layout_navigator? fun(menu: Denu, x: sign, y: sign, direction?: direction, context: Denu.context)
---@field items_source Denu.items_source
---@field on_show? fun(menu: Denu, args: Denu.show.args, context: Denu.context): boolean
---@field on_hide? fun(menu: Denu)
---@field on_ready? fun(menu: Denu, args: Denu.show.args, context: Denu.context)
---@field mouse_move_select boolean
---@field mouse_move_show_submenu boolean
...
---@param text string
---@return fun(menu: Denu): XDenuItem
...
function M.object:show_submenu(index, context)
    ...
    if not submenu then
        local submenu_args = type(item.submenu) == "function"
            and item.submenu(self) --[[@as Denu.new.args]]
            or item.submenu
...
---@field mouse_move_select? boolean
---@field mouse_move_show_submenu? boolean
---@field buttons_builder? fun(menu: Denu): awful.button[]
---@field keygrabber_builder? fun(menu: Denu): awful.keygrabber
---@field item_template? widget_template
---@field separator_template? widget_template
---@field header_template? widget_template

---@param args? Denu.new.args
...
function M.new(args, is_submenu)
    ...
    self._private.layout_container = self:get_children_by_id("#root")[1] --[[@as wibox.container]]
    ...
    self.buttons = args.buttons_builder
    ...
    if not is_submenu then
        if args.keygrabber_builder ~= false then
            self._private.keygrabber = args.keygrabber_builder
